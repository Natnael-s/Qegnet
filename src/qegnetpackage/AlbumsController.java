...
import qegnetpackage.AlbumDetailsController;
...
private static final String DEFAULT_ALBUM_ART_PATH = "C:\\Users\\Natnael\\Pictures\\icons8-singer-64.png";
        ...
        for (String albumTitle : albumsByTitle.keySet()) {
           ...
           if (albumTitle == null || albumTitle.isEmpty()) {
              ...
              if (albumImageData != null && !albumTitle.equals(DEFAULT_ALBUM_TITLE)) {
                ...
                albumArtView.setFitHeight(140);
                albumArtView.setFitWidth(140);
                albumArtView.setPreserveRatio(true);
                Label albumTitleLabel = new Label(albumTitle);
                albumTitleLabel.setStyle("-fx-font-family: 'Verdana'; -fx-background-color:'white'; -fx-font-size: 18px;");
                VBox albumBox = new VBox(albumArtView, albumTitleLabel);
                albumBox.setAlignment(Pos.CENTER);
                albumBox.setSpacing(10);
                albumBox.setMinSize(200, 200);
                 albumBox.setMaxSize(200, 200);
                 albumBox.setStyle("-fx-border-style: solid inside;" +
                  "-fx-border-width: 2;" +
                  "-fx-border-radius: 3;" 
                             );
                 gridPaneController.setStyle("-fx-background-color: white;");
